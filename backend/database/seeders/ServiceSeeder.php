...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('  - Électricité: 1 service avec 8 catégories');
        $this->command->info('  - Menuiserie: 1 service avec 7 catégories');
        $this->command->info('  - Peinture: 1 service avec 7 catégories');
        $this->command->info('  Total: 3 services complets avec disponibilités');
    }
}
